...
app.get("/", async function(req, res) {
    let apiUrl = `https://api.unsplash.com/photos/random/?client_id=LI-edkTRLEAns3nhYl5U6_d3odR578M48EYehYipOds&featured=true&orientation=landscape`;
...
app.get("/search", async function(req, res) {
    ...
    let apiUrl = `https://api.unsplash.com/photos/random/?count=9&client_id=LI-edkTRLEAns3nhYl5U6_d3odR578M48EYehYipOds&featured=true&orientation=landscape&query=${keyword}`;
    let response = await fetch(apiUrl);
    let data = await response.json();
